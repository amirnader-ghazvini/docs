...
Minting of FPI (using FRAX) and redeeming FPI (to receive FRAX) can be done at any time for a small fee using the FPI Controller Pool. Users can also buy/sell FPI in various markets such as Curve or Fraxswap.
